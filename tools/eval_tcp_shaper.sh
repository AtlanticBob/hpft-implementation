...
ssh -o BatchMode=yes sgpu02 'ss -ltn | grep -q 5353 || (setsid python3 /tmp/tcp_rr_server.py 5353 >/dev/null 2>&1 & sleep 0.5)' 2>/dev/null

# M1: cap goodput (no RR)
ssh -o BatchMode=yes sgpu02 'pkill -u zhaoxiang iperf3 2>/dev/null; sleep 0.5; setsid nohup iperf3 -s -1 -p 5381 >/tmp/ips.log 2>&1 </dev/null & sleep 1'
...
ssh -o BatchMode=yes sgpu02 'pkill -u zhaoxiang iperf3 2>/dev/null; sleep 0.5; setsid nohup iperf3 -s -1 -p 5382 >/tmp/ips.log 2>&1 </dev/null & sleep 1'
...
M4=$(gp m4.log)
ssh -o BatchMode=yes sgpu02 'pkill -u zhaoxiang iperf3 2>/dev/null'
