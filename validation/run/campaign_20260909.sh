#!/usr/bin/env bash
# First pass over the suite (2026-09-09, token pool executor): waits for the
...
LOG=${1:-/tmp/campaign_20260909.log}
...
one V1_incast            V1_bucket_20260909 V1 X=1
one V1_incast            V1swift_20260909   V1swift HPFT_RDMA_CC_ALGO=3
one V2_flowset_join_leave V2_bucket_20260909 V2 X=1
one V4_demand_change     V4_bucket_20260909 V4 X=1
one V3_tenant_join_leave V3_bucket_20260909 V3 X=1
one V5_single_dst_cap    V5_bucket_20260909 V5 X=1
one V6_other_cc          V6_bucket_20260909 V6 X=1
echo "=== $(date +%T) campaign a done (V7 and V8 are in campaign_20260909_b.sh)" >> "$LOG"
