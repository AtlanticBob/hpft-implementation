...
LOG=${1:-/tmp/campaign_20260909_b.log}
...
one V7_cc_coexist V7_bucket_20260909 V7 X=1
...
if [ "$up" = "up up " ]; then
  ...
  one V8_core V8_bucket_20260909 V8 X=1
  one V8_core V8cc_20260909 V8cc HPFT_CC_ONLY=1
else
