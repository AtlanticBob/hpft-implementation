...
## vf2/vf3 扩展 + 四 pair 并发(2026-07-04 收官)

- 新增 0xdea 调试操作(fail-open 路径记录未知 flowtag)→ 实测
  vf2=0xde985a90、vf3=0x7973f1b0(vf0/vf1 刷机后未变);
- 两端 agent 扩至 4 VF,caps 文件四行;
- **四 pair 并发(8/4/2/2G,各 4QP)**:8.00 / 4.02 / 2.02 / 2.03 Gbps,
  误差 +0.0% / +0.6% / +1.2% / +1.7%。
